...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/azure-cosmos-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/azure-cosmos-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add azure-cosmos
# for installing globally
pixi global install azure-cosmos
```
...
It is possible to list all of the versions of `azure-cosmos` available on your platform:
...
```
pixi search azure-cosmos --channel conda-forge
```
