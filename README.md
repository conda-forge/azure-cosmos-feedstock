...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/azure-cosmos-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6373&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/azure-cosmos-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `azure-cosmos` can be installed with:

```
conda install azure-cosmos
```

It is possible to list all of the versions of `azure-cosmos` available on your platform with:
